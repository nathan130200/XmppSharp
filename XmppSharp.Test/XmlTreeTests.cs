...
public class XmlTreeTests
{
    ...
    {
        var elem = await ParserTests.ParseFromBuffer(@"<mission name=""!!!Volcano_Nightmare"" time_of_day=""12"" game_mode=""pve"" game_mode_cfg=""pve_mode.cfg"" uid=""1bbe889f-cba6-41e2-9844-a2257d3ac25d"" release_mission=""0"" clan_war_mission=""0"" only_clan_war_mission=""0"" difficulty=""survival"" mission_type=""volcanosurvival"">
