...
public readonly struct StanzaErrorCondition : IXmppEnum<StanzaErrorCondition>
{
    ...
    #region ErrorCondition Members

    public override bool Equals(object? obj)
    {
        if (obj is not StanzaErrorCondition other)
            return false;
    ...
    public XmlElement CreateElement(XmlDocument? document = default)
        => Namespace.Stanzas.CreateElement(_value, document);
